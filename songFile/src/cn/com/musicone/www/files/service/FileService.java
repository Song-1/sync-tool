 ...
 * 
 */
package cn.com.musicone.www.files.service;
...
public interface FileService {
	...
	public void addFileLocalPath(List<FileLocalPathModel> datas)throws Exception;
	public int getFileLocalPathData(String path)throws Exception;
	
	public List<FileLocalPathModel> listFileLocalPathDatas(int start)throws Exception;
