...
public class UpYun {
	...
	public static void init() throws Exception {
		...
		if (p != null) {
			...
			OPERATOR_PWD = p.getProperty("upyun.operatorPwd");
			RETURN_URL = p.getProperty("upyun.returnUrl");
			FORM_API_SECRET =  p.getProperty("upyun.formApiSecret");
			MULTI_PART_SIZE =  p.getProperty("upyun.multipartSize");
		}
	}
